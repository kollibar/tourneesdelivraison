...
/**
 * \file    test/functional/TourneesDeLivraisonFunctionalTest.php
...
/**
 * Class TourneesDeLivraisonFunctionalTest
 *
 ...
 *
 * @package Testtourneesdelivraison
 */
class TourneesDeLivraisonFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modTourneesDeLivraison')->click();
		} else {
			// Disable the module
			$this->byHref('modTourneesDeLivraison')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/tourneesdelivraison/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('tourneesdelivraison/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/tourneesdelivraison/admin/about.php');
		$this->authenticate();
		return $this->assertContains('tourneesdelivraison/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('tourneesdelivraisonwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modTourneesDeLivraison_TourneesDeLivraisonTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modTourneesDeLivraison_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
