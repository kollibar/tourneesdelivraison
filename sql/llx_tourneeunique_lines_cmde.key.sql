...
ALTER TABLE llx_tourneeunique_lines_cmde ADD INDEX idx_tourneeunique_lines_cmde_rowid (rowid);
ALTER TABLE llx_tourneeunique_lines_cmde ADD CONSTRAINT llx_tourneeunique_lines_cmde_fk_user_creat FOREIGN KEY (fk_user_creat) REFERENCES llx_user(rowid);
