...
class TourneeDeLivraison_lines extends TourneeGeneric_lines
{
	...
	public $fields=array(
		...
		'fk_adresselivraison' => array('type'=>'integer:Contact:contact/class/contact.class.php', 'label'=>'Contact', 'enabled'=>1, 'visible'=>1, 'position'=>54, 'notnull'=>-1,),
	...
	public function createLineTourneeUnique(User $user,$fk_tourneeunique, $fk_parent_line=0){
		...
		if( $this->type==TourneeGeneric_lines::TYPE_THIRDPARTY){
			...
			$object->fk_adresselivraison=$this->fk_adresselivraison;
