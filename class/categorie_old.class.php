...
class Categorie_old extends CommonObject{
    ...
    const TYPE_TOURNEEUNIQUE = 'tourneeunique';
    ...
    const TYPE_TOURNEE_LINES = 'tournee_lines';
      ...
      'project'      => 6,
  		...
  		'bank_line'    => 8,
      'tourneeunique' => 10,
      'tourneeunique_lines' => 11,
      'tourneedelivraison' => 12,
      'tourneedelivraison_lines' => 13,
  	);
  	...
  	public static $MAP_ID_TO_CODE = array(
  		...
  		8 => 'bank_line',
      10 => 'tourneeunique',
      11 => 'tourneeunique_lines',
      12 => 'tourneedelivraison',
      13 => 'tourneedelivraison_lines',
  	);
  	...
  	private $MAP_CAT_FK = array(
          ...
          'project'  => 'project',
          'tourneeunique' => 'tourneeunique',
          'tourneeunique_lines' => 'tourneeunique_lines',
          'tourneedelivraison' => 'tourneedelivraison',
          'tourneedelivraison_lines' => 'tourneedelivraison_lines',
  	);
