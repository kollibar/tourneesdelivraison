 ...
 */
class TourneeDeLivraison_lines_contacts extends TourneeGeneric_lines_contacts
{
	/**
	 * @var string ID to identify managed object
	 */
	public $element = 'tourneedelivraison_lines_contacts';
	public $nomelement = 'TourneeDeLivraison_lines_contacts';

	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'tourneedelivraison_lines_contacts';
	/**
	 * @var int Field with ID of parent key if this field has a parent
	 */
	public $fk_element = 'fk_tournee_lines_contacts';
	/**
	 ...
	 */
	public $picto = 'tourneedelivraison_lines_contacts@tourneesdelivraison';
	...
	public $fields=array(
		...
		'fk_tournee_lines' => array('type'=>'integer:TourneeDeLivraison_lines:tourneesdelivraison/class/tourneedelivraison_lines.class.php', 'label'=>'TourneeDeLivraison_Lines', 'enabled'=>1, 'visible'=>1, 'position'=>40, 'notnull'=>1,),
	...
	public function getNewTourneeLine(){
		$tournee = new TourneeDeLivraison_lines($this->db);
		return $tournee;
	}


	public function createLineContactTourneeUnique(User $user,$fk_tourneeunique_lines, $fk_parent_line=0){
		global $langs, $hookmanager, $extrafields;
		$error = 0;

		dol_syslog(__METHOD__, LOG_DEBUG);

		$object = new TourneeUnique_lines_contacts($this->db);
		...
		$object->fk_socpeople=$this->fk_socpeople;

		$object->fk_parent_line=$fk_parent_line;
		$object->fk_tournee_lines=$fk_tourneeunique_lines;
