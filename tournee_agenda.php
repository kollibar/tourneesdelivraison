...
/**
 *  \file       tourneedelivraison_agenda.php
 *  \ingroup    tourneesdelivraison
 *  \brief      Page of TourneeDeLivraison events
 */
/*
...
$typetournee = str_replace("_agenda.php","", $arr[count($arr)-1]);
...
$hookmanager->initHooks(array($typetournee.'agenda','globalcard'));     // Note that conf->hooks_modules contains array
...
if ($object->id > 0)
{
	...
	dol_fiche_head($head, 'agenda', $langs->trans($typenom), -1, $typetournee.'@tourneesdelivraison');
    ...
    if (! empty($conf->agenda->enabled) && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read) ))
    {
		...
		print load_fiche_titre($langs->trans("ActionsOn".$typenom),'','');
