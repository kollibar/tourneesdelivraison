...
$typetournee = str_replace(".php","", $arr[count($arr)-1]);
...
else
{
	...
	if (! is_object($form)) $form = new FormTourneesDeLivraison($db);
	$arrayresult=$form->select_tournee_list($typetournee, 0, $htmlname, $filter, 1, 0, null, $searchkey, $outjson);
