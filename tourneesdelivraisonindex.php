...
/**
 *	\file       htdocs/tourneesdelivraison/template/tourneesdelivraisonindex.php
 *	\ingroup    tourneesdelivraison
 *	\brief      Home page of tourneesdelivraison top menu
 */
...
$langs->loadLangs(array("tourneesdelivraison@tourneesdelivraison"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->tourneesdelivraison->read) accessforbidden();
...
llxHeader("",$langs->trans("TourneesDeLivraisonArea"));

print load_fiche_titre($langs->trans("TourneesDeLivraisonArea"),'','tourneesdelivraison.png@tourneesdelivraison');
...
// Draft MyObject
if (! empty($conf->tourneesdelivraison->enabled) && $user->rights->tourneesdelivraison->read)
{
	$langs->load("orders");
