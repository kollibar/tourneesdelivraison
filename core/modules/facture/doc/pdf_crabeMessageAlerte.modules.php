...
/**
 *	\file       htdocs/core/modules/facture/doc/pdf_crabeMessageAlerte.modules.php
 *	\ingroup    facture
 *	\brief      File of class to generate customers invoices from crabeMessageAlerte model
 */
...
/**
 *	Class to manage PDF invoice template crabeMessageAlerte
 */
class pdf_crabeMessageAlerte extends ModelePDFFactures
{
     /**
	...
	function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "crabeMessageAlerte";
		$this->description = $langs->trans('PDFcrabeMessageAlerteDescription');
