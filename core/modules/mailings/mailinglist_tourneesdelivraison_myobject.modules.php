...
dol_include_once("/tourneesdelivraison/class/myobject.class.php");


/**
 * mailing_mailinglist_tourneesdelivraison
 */
class mailing_mailinglist_tourneesdelivraison_myobject extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	var $name='mailinglist_tourneesdelivraison_myobject';
	...
	var $picto='tourneesdelivraison@tourneesdelivraison';
	...
	function __construct($db)
	{
		...
		{
			$this->enabled=in_array('tourneesdelivraison',$conf->modules)?1:0;
		}
	}
	...
	function url($id)
	{
		return '<a href="'.dol_buildpath('/tourneesdelivraison/myobject_card.php',1).'?id='.$id.'">'.img_object('',"generic").'</a>';
	}
	...
	function add_to_target($mailing_id,$filtersarray=array())
	{
		...
		if ($result)
		{
			...
			dol_syslog("mailinglist_tourneesdelivraison_myobject.modules.php: mailing ".$num." targets found");
