...
/**
 * \file    modulebuilder/template/core/boxes/tourneesdelivraisonwidget1.php
 * \ingroup tourneesdelivraison
 * \brief   Widget provided by TourneesDeLivraison
 *
 ...
 */
class tourneesdelivraisonwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "tourneesdelivraisonbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "tourneesdelivraison@tourneesdelivraison";
	 ...
	 */
	public $depends = array('tourneesdelivraison');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->tourneesdelivraison->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		$this->info_box_head = array(
			...
			'subpicto' => 'object_tourneesdelivraison@tourneesdelivraison',
